...
pub(crate) static SLASHER_NUM_ATTESTATIONS_DROPPED: LazyLock<Result<IntGauge>> =
    LazyLock::new(|| {
        try_create_int_gauge(
...
pub(crate) static SLASHER_NUM_ATTESTATIONS_DEFERRED: LazyLock<Result<IntGauge>> =
    LazyLock::new(|| {
        try_create_int_gauge(
...
pub(crate) static SLASHER_NUM_ATTESTATIONS_VALID: LazyLock<Result<IntGauge>> =
    LazyLock::new(|| {
        try_create_int_gauge(
...
pub(crate) static SLASHER_NUM_ATTESTATIONS_STORED_PER_BATCH: LazyLock<Result<IntGauge>> =
    LazyLock::new(|| {
        try_create_int_gauge(
...
pub(crate) static SLASHER_NUM_BLOCKS_PROCESSED: LazyLock<Result<IntGauge>> = LazyLock::new(|| {
    try_create_int_gauge(
        "slasher_num_blocks_processed",
        "Number of blocks processed per batch",
    )
});
pub(crate) static SLASHER_NUM_CHUNKS_UPDATED: LazyLock<Result<IntCounterVec>> =
    LazyLock::new(|| {
...
pub(crate) static SLASHER_COMPRESSION_RATIO: LazyLock<Result<Gauge>> = LazyLock::new(|| {
    try_create_float_gauge(
        "slasher_compression_ratio",
        "Compression ratio for min-max array chunks (higher is better)",
    )
});
pub(crate) static SLASHER_NUM_ATTESTATION_ROOT_QUERIES: LazyLock<Result<IntCounter>> =
    LazyLock::new(|| {
...
pub(crate) static SLASHER_NUM_ATTESTATION_ROOT_HITS: LazyLock<Result<IntCounter>> =
    LazyLock::new(|| {
        try_create_int_counter(
...
pub(crate) static SLASHER_ATTESTATION_ROOT_CACHE_SIZE: LazyLock<Result<IntGauge>> =
    LazyLock::new(|| {
        try_create_int_gauge(
