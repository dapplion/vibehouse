...
pub(crate) fn update_progressive_balances_on_attestation<E: EthSpec>(
    state: &mut BeaconState<E>,
    epoch: Epoch,
    flag_index: usize,
...
pub(crate) fn update_progressive_balances_on_slashing<E: EthSpec>(
    state: &mut BeaconState<E>,
...
pub(crate) fn update_progressive_balances_on_epoch_transition<E: EthSpec>(
    state: &mut BeaconState<E>,
    spec: &ChainSpec,
...
pub(crate) fn update_progressive_balances_metrics(
