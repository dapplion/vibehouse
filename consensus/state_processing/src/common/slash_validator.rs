...
mod tests {
    ...
    use types::{
        ...
        Eth1Data, ExecutionBlockHash, ExecutionPayloadBidGloas, ExitCache, ForkName,
        MinimalEthSpec, ParticipationFlags, ProgressiveBalancesCache, PubkeyCache, SlashingsCache,
        SyncCommittee, Validator, beacon_state::BuilderPubkeyCache,
    };
