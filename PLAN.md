...
[docs/tasks/spec-tests.md](docs/tasks/spec-tests.md) — DONE: 78/78 + 138/138 passing, check_all_files_accessed passes, spec tracked to v1.7.0-alpha.2, automated release check workflow deployed
...
- **Rebranding** — in progress: binary renamed, all crate names renamed (vibehouse_network, vibehouse_tracing, vibehouse_version, vibehouse_validator_store), LighthouseSubcommands→VibehouseSubcommands, eth2 feature flag lighthouse→vibehouse, lighthouse/lighthouse_vc modules→vibehouse/vibehouse_vc, all function names/variables/constants/string literals/comments/API paths renamed. Remaining: `lighthouse/` source directory rename (the main binary crate directory)
