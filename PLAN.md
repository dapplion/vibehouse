...
Spec tests: [docs/tasks/spec-tests.md](docs/tasks/spec-tests.md) — DONE: 80/80 + 142/142 passing (v1.7.0-alpha.4 vectors, Heze SSZ static types added), automated release check workflow deployed
