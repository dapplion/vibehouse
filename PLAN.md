...
- **Test coverage** — in progress (21 Gloas fork choice unit tests + 17 bid processing unit tests added; remaining gaps: envelope processing, block replay, withdrawals)
