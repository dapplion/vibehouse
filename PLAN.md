...
[docs/tasks/spec-tests.md](docs/tasks/spec-tests.md) — 78/78 + 138/138 passing, check_all_files_accessed passes, should_extend_payload PTC threshold fix (run 233)
...
- **CI workflow** — DONE (`.github/workflows/ci.yml`: check, ef-tests, unit-tests, fork-specific-tests; `nightly-tests.yml`: all prior forks beacon_chain/network/op_pool + http_api electra/fulu)
