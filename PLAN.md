...
Spec tests: [docs/tasks/spec-tests.md](docs/tasks/spec-tests.md) — DONE: 82/82 + 144/144 passing (v1.7.0-alpha.4 vectors, Heze SSZ static types, gossip validation tests for proposer/attester slashings across all forks), automated release check workflow deployed
