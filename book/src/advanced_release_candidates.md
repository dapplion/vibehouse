...
[dapplion/vibehouse]: https://github.com/dapplion/vibehouse
[dapplion/vibehouse/releases/latest]: https://github.com/dapplion/vibehouse/releases/latest
[dapplion/vibehouse/releases]: https://github.com/dapplion/vibehouse/releases
[`v1.4.0-rc.0`]: https://github.com/dapplion/vibehouse/releases/tag/v1.4.0-rc.0
[`v1.4.0`]: https://github.com/dapplion/vibehouse/releases/tag/v1.4.0

From time-to-time, Vibehouse *release candidates* will be published on the [dapplion/vibehouse]
...
[dapplion/vibehouse/releases/latest]. However, release candidates *will* show up on the
[dapplion/vibehouse/releases] page, so **please pay attention to avoid the release candidates when
you're looking for stable Vibehouse**.

From time to time, Vibehouse may use the terms "release candidate" and "pre release"
