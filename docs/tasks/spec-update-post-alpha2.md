...
### run 1123 (Mar 13) — all stable, ptc-lookbehind rebased
Spec completely stable — no new consensus-specs commits since #4940 (Mar 13). No new release (still v1.7.0-alpha.2). No new spec-test vectors (still v1.6.0-beta.0). CI green. Nightly green (3 consecutive). No dep updates available. cargo audit unchanged (1 rsa, 5 warnings). Rebased `ptc-lookbehind` onto main — 575/575 state_processing tests pass. PR #4992 still OPEN, NOT MERGED, same head d76a278b0a. All tracked spec PRs (#4932, #4939, #4960, #4962, #5003) unchanged.
