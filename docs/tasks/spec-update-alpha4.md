...
- Runs 3923-3948 (2026-03-29): No new consensus-specs merges or releases since alpha.4 (Mar 27). All 9 open Gloas/Heze PRs unchanged throughout: #4843 (approved/stalled since Mar 20), #4747 (FCR, dirty/conflicting, 79 commits, 148 reviews), #4954/#4898/#4892/#4960/#4932/#4840/#4630 (stale/unreviewed). #5036 still open but effectively dead. Zero clippy warnings, zero compatible dep updates (except iri-string 0.7.11→0.7.12 in run 3945). Cargo audit unchanged (1 rsa vuln, no fix). EF spec tests: 86/86 + 148/148. Build clean. CI all green. Codebase stable.
- Runs 3949-3952 (2026-03-29): No new consensus-specs merges or releases since alpha.4 (Mar 27). Last merge: #5053 (Mar 27). All 8 open Gloas/Heze PRs unchanged: #4843 (approved/stalled), #4747 (FCR, conflicting), #4954/#4898/#4892/#4840/#4630 (stale/unreviewed), #5036 (effectively dead). #4960/#4932 (test vectors). Zero compatible dep updates. Build clean. No new vibehouse issues or PRs.
- Runs 3953-3958 (2026-03-29): No new consensus-specs merges or releases since alpha.4 (Mar 27). Last merge: #5053 (Mar 27). All open Gloas/Heze PRs unchanged: #4843 (approved/stalled), #4747 (FCR, conflicting), #4954/#4898/#4892/#4840/#4630 (stale/unreviewed), #5036 (effectively dead), #4960/#4932 (test vectors). Zero compatible dep updates. Zero clippy warnings. Build clean.
- Run 3959 (2026-03-29): No new consensus-specs merges or releases. All open Gloas/Heze PRs unchanged. Optimized `handle_data_columns_by_root_request` to use `iter().copied()` instead of `clone()` on `VariableList<ColumnIndex>` in flat_map, avoiding per-identifier Vec allocation. Network tests: 214/214 pass. Commit 5eb408d6b.
- Run 3960 (2026-03-29): No new consensus-specs merges or releases since alpha.4 (Mar 27). Last merge: #5053. All open Gloas/Heze PRs unchanged: #4843 (approved/stalled), #4747 (FCR, conflicting), #4954/#4898/#4892/#4960/#4932/#4840/#4630 (stale/unreviewed). Zero clippy warnings. Zero compatible dep updates. Build clean. Codebase stable.
- Run 3961 (2026-03-29): No new consensus-specs merges or releases since alpha.4 (Mar 27). All open Gloas/Heze PRs unchanged. Removed 2 dead code enum variants (observed_attesters::ReachedMaxObservationsPerSlot, naive_aggregation_pool::IncorrectSlot) and stale blanket #[allow(dead_code)] on attester_cache::Error. 1013 beacon_chain tests pass. Commit cc350b705.
- Run 3962 (2026-03-29): New open PR #5056 ("Add check on bid gossip for blob kzg commitment len", tagged `gloas`). Proactively implemented: added [REJECT] check in `verify_execution_bid_for_gossip` for `blob_kzg_commitments` length exceeding `max_blobs_per_block`. Check was already in block processing (`process_execution_payload_bid`) but missing from gossip validation. Added `TooManyBlobKzgCommitments` error variant, gossip handler with peer scoring, and integration test. 51 bid tests + 1 network test pass. Commit 42e33200c.
- Run 3963 (2026-03-29): No new consensus-specs merges or releases since alpha.4 (Mar 27). Last merge: #5053 (Mar 27). #5056 still open (0 comments, 0 reviews). All open Gloas/Heze PRs unchanged: #4843 (approved/stalled), #4747 (FCR, conflicting), #4954/#4898/#4892/#4960/#4932/#4840/#4630 (stale/unreviewed). Zero clippy warnings. Zero compatible dep updates. Cargo audit unchanged (1 rsa vuln, no fix). Full code quality audit: no production unwrap()/expect() panics, all TODOs have issue links, all #[allow(dead_code)] justified. Codebase stable.
