...
- Run 2972: Monitoring pass — no new consensus-specs merges since #5044/#5046. v1.7.0-alpha.4 still not published. EF test vectors still v1.6.0-beta.0. All open Gloas PRs unchanged (#4843, #4747 at 142 reviews). CI green, clippy clean, cargo audit unchanged. Only outdated dep is rand_xorshift 0.4→0.5 (major bump). No actionable work.
