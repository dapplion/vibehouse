...
- Run 3803 (2026-03-28): Monitoring. No new consensus-specs merges since #5053 (Mar 27). No new releases (still alpha.4). All 8 open Gloas/Heze PRs unchanged: #4843 (approved/stalled), #4747 (FCR, conflicting), #4954 (unreviewed), #4898/#4892 (stale), #4960/#4932 (test vectors), #4840/#4630 (stale). Recent non-Gloas PRs: #5055 (EIP-8025 refactor), #5054 (test workflow), #5050 (networking tests), #5049 (gossip validation) — none relevant. CI in progress. Codebase stable, no actionable work.
