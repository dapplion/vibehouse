...
Runs 2592-2603: No new spec PRs merged since run 2591. All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). #4747 updated Mar 25 but still conflicting. #5036 still open but dead (both author and reviewer opposed). v1.7.0-alpha.4 tag exists (a9bc79a7) but no GitHub release published yet (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI green, nightly green (Mar 25). No actionable work.
