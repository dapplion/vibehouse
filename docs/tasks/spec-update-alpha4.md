...
Runs 2511-2512: No new spec PRs merged since run 2510. All 8 open Gloas PRs unchanged (#5036, #4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.6.1, no alpha.4 tag). EF test vectors still v1.6.0-beta.0. CI green. No actionable work.
