...
Runs 2879-2883 (2026-03-26): No new spec PRs merged since run 2878. New PR #5045 opened (remove @always_bls decorator — test infra only, not relevant). #5044 still open (0 comments, 0 reviews, mergeable_state=blocked — blocking alpha.4 release). All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630, #5044). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI in progress for compute_ptc optimization commit (check+clippy+ef-tests passed, 4 jobs running). All 10 remaining TODOs blocked on external deps. No actionable work.
