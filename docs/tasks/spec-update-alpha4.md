...
**Monitoring (runs 3876-3879, 2026-03-29):**
...
- Nightly tests (run 23705614396): 28/31 jobs complete, all passing. Remaining: http-api fulu/electra, beacon-chain fulu (in progress).
