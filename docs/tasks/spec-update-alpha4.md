...
- Run 3086 (2026-03-27): Steady state. No new consensus-specs merges since #5048. v1.7.0-alpha.4 still not published (latest = v1.7.0-alpha.3). All deps at latest compatible versions (0 lockfile changes). CI: all 5 recent runs green. Open Gloas PRs unchanged. No actionable work.
