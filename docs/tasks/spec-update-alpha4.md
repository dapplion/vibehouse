...
- Runs 3231-3232 (2026-03-27): Steady state. No new consensus-specs merges since #5048. All deps at latest (0 compatible updates). CI: in progress (check/clippy/fmt/EF tests/network/op_pool/http_api all passed, unit+beacon_chain still running). All 9 open Gloas PRs unchanged. No actionable work.
