...
Runs 2713-2770 (2026-03-26): No new spec PRs merged since run 2712 (latest merged: #5042 Mar 25). No new Gloas PRs opened. All open Gloas PRs unchanged (#4843, #4898, #4892, #4954, #4747, #4840, #4630). #4747 (FCR) updated Mar 26 — new test vectors posted (fcr-fulu-8241c1d7), discussion on optimistic sync interaction (mkalinin: "FCR should be conservative and not confirm optimistic blocks"), still open/dirty/conflicting with 146 review comments. v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI green, nightly Mar 26 passed. cargo audit unchanged (1 rsa vuln, 5 unmaintained). 10 TODOs remain, all blocked on external deps. No actionable work.
