...
Runs 2924-2947 (2026-03-26): Continuous monitoring. No new spec PRs merged or opened since #5044/#5046 (Mar 26 19:03Z). All open Gloas PRs unchanged (#5045, #4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3) — #5044 and #5046 merges should unblock test generation. EF test vectors still v1.6.0-beta.0. CI fully green (ci, nightly, spec-test-check). Clippy zero warnings. cargo audit unchanged. No actionable work.

Runs 2948-2949 (2026-03-26): No new spec PRs merged or opened since #5044/#5046. Open Gloas PRs unchanged: #5045 (test infra), #5036 (effectively dead), #4843 (variable PTC deadline, proactively implemented), #4898/#4892 (fork choice simplifications, already match), #4960/#4932 (test vectors), #4954 (milliseconds refactor), #4747 (FCR, CONFLICTING), #4840 (EIP-7843, stale), #4630 (EIP-7688, stale). v1.7.0-alpha.4 release still not published (latest = v1.6.1). EF test vectors still v1.6.0-beta.0. CI fully green. No actionable work.

Run 2950 (2026-03-26): No new spec PRs merged or opened since #5044/#5046 (Mar 26 19:03Z). All open Gloas PRs unchanged (#5045, #5046, #4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI fully green. No actionable work.
