...
### Steady state (runs 3966-4123, 2026-03-29/30)

No new consensus-specs merges or releases since alpha.4 (Mar 27). Post-alpha.4 merges (#5051-5054) are all CI/tooling/test-infra. All open Gloas/Heze PRs unchanged: #4843 (approved/stalled since Mar 20), #4747 (FCR, 79 commits, still in active review — new comment Mar 30 on floor/ceil for committee weight estimation), #5056 (approved, not merged), #4954/#4898/#4892/#4960/#4932/#4840/#4630 (stale/unreviewed). Cargo check clean, zero clippy warnings. Devnet health check (run 4123): 4-node Gloas devnet SUCCESS — finalized_epoch=8, continuous finalization, no stalls. Codebase stable.
