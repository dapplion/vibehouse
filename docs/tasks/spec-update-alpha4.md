...
- Runs 3187-3192 (2026-03-27): Steady state. No new consensus-specs merges since #5048. Latest release still v1.7.0-alpha.3 (alpha.4 tag exists, no release published). EF test vectors still v1.6.0-beta.0 (Sep 2025). All deps at latest (0 updates available). CI: all green (ci, nightly, spec-test-check). Clippy clean, cargo audit unchanged (1 transitive rsa vuln). All 8 open Gloas PRs unchanged. #4747 FCR still dirty/unmergeable (79 commits, 148 reviews). Production code unwrap audit confirmed clean (0 unwraps in consensus-critical paths).
