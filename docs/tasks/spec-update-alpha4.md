...
No v1.7.0-alpha.4 release/tag created yet on consensus-specs (as of run 2397, 2026-03-25). Version bump PR (#5034) merged Mar 24 but no GitHub release published. Spec-test-check workflow will auto-detect when it's published. Current pinned version: v1.7.0-alpha.3. EF test vectors also not updated (latest: v1.6.0-beta.0 from Sep 2025). No new Gloas PRs merged since last check (last merged: #5035, #4962, #4939 on Mar 24-25). All open PRs unchanged (#4979, #5036, #4843, #4747, #4960, #4932, #4898, #4892 all still OPEN). #4979 latest commits (e7b1910, 89ce53b0 on Mar 24) are doc/typo fixes only — no behavioral changes. No new open PRs. CI green (main + nightly). Clippy clean. No action needed this run.
