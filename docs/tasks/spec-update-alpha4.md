...
- Run 3150 (2026-03-27): Steady state. No new consensus-specs merges since #5048. v1.7.0-alpha.4 tag exists (a9bc79a7), no GitHub Release published (latest release = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0 (Sep 2025). CI: all green (ci + nightly). Zero clippy warnings. cargo audit unchanged (1 rsa vuln, 5 unmaintained). All deps at latest (0 lockfile changes). All open Gloas PRs unchanged. No actionable work.
