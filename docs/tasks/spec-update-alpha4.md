...
Run 2874 (2026-03-26): No new spec PRs merged since run 2873. #5044 still open (blocking alpha.4 release). All open Gloas PRs unchanged. v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI green (nightly passing, ci in progress for unicode-segmentation 1.13.2 fix). No actionable work.
