...
- Run 2972-2992: Monitoring passes — no new consensus-specs merges since #5044/#5046. Only new PR: #5045 (remove `@always_bls` decorator, test infra). v1.7.0-alpha.4 still not published (latest release = v1.7.0-alpha.3, consensus-specs latest release = v1.6.1). EF test vectors still v1.5.0 (2025-05-07). All open Gloas PRs unchanged (#4843 APPROVED but mergeable_state=blocked, #4898/#4892 APPROVED but stale, #4960 needs review, #4932 conflicting, #4954 still 0 reviews, #4747 still dirty/conflicting with 146 review comments). CI green, clippy clean (zero warnings), cargo audit unchanged (1 rsa vuln, 5 unmaintained warnings). All deps at latest compatible versions (`cargo update --dry-run` = 0 packages). No actionable work.
