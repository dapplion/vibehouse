...
Runs 2507-2508: No new spec PRs merged since run 2506. All 8 open Gloas PRs unchanged (#5036, #4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI green. Clippy: zero warnings. #4558 (Cell Dissemination) merged but blocked on rust-libp2p partial message support. No actionable work.
