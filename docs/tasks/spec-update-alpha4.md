...
Runs 2924-2940 (2026-03-26): Continuous monitoring. No new spec PRs merged or opened. All open Gloas PRs unchanged (#5045, #4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI fully green. cargo audit unchanged (1 rsa vuln, 5 unmaintained). No actionable work.
