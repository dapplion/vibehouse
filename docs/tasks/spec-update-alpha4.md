...
**Steady state (as of run 2971):**
- v1.7.0-alpha.4 release: NOT published (latest = v1.7.0-alpha.3). Tag a9bc79a7 exists but release action timed out.
...
- CI: fully green (ci, nightly, spec-test-check). Clean build, zero clippy warnings. cargo audit unchanged (1 rsa vuln).
...
- Runs 2971-3002: No new consensus-specs merges since #5044/#5046 (2026-03-26T19:03Z). v1.7.0-alpha.4 tag exists but release not published (latest = alpha.3). EF test vectors still v1.6.0-beta.0 (upstream nightly failing since 2026-03-08). All 9 open Gloas PRs unchanged. CI green, clippy clean, cargo audit unchanged (1 rsa vuln in jsonwebtoken transitive dep — not actionable). Only 1 outdated root dep (rand_xorshift 0.4→0.5).
- Runs 3002-3017 (2026-03-27): Steady state monitoring. No new consensus-specs merges since #5044/#5046 (2026-03-26T19:03Z). v1.7.0-alpha.4 tag exists but no GitHub Release published (latest release = v1.6.1). EF test vectors still v1.6.0-beta.0 (upstream nightly generation failing since 2026-03-08). All 9 open Gloas PRs unchanged: #4843/#4898/#4892 (approved but stale), #4954/#4747/#4960/#4932/#4840/#4630 (open). CI fully green, nightly tests passing. Zero clippy warnings, zero compiler warnings. cargo audit: 1 rsa vuln (no fix available). Dep updates: cmake 0.1.57→0.1.58 (run 2805), data-encoding-macro-internal syn 1→2 (run 3005). No actionable work.
- Run 3018 (2026-03-27): Steady state. No new consensus-specs merges. Latest consensus-specs release still v1.7.0-alpha.3 (2026-03-13). EF test vectors still v1.5.0 (2025-05-07). All 8 open Gloas PRs unchanged (#5036 still open but effectively dead). CI green. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Run 3019 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26T19:03Z). Latest release still v1.7.0-alpha.3. 8 open Gloas PRs unchanged. #4747 (FCR) still dirty with 146 review comments. CI green. rand_xorshift 0.4→0.5 investigated but not viable (requires rand 0.10, we're on 0.9 — would need workspace-wide rand migration). No actionable work.
- Run 3020 (2026-03-27): Steady state. No new consensus-specs merges. Latest release still v1.7.0-alpha.3. EF test vectors still v1.5.0 (2025-05-07). Upstream nightly tests: success on 2026-03-25, cancelled on 2026-03-26 and 2026-03-27. 8 open Gloas PRs unchanged. CI green. No actionable work.
- Run 3021 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). Latest consensus-specs release still v1.6.1 (2025-11-15). EF test vectors still v1.5.0 (2025-05-07). 8 open Gloas PRs unchanged. Zero clippy warnings. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Run 3022 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. New non-Gloas PRs: #5048 (testing label), #5047/#5033 (gossip validation functions for bellatrix/altair — not relevant). CI green. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Run 3023 (2026-03-27): Steady state. No new consensus-specs merges. 8 open Gloas PRs unchanged (#4843/#4898/#4892/#4954/#4747/#4960/#4932/#4630 + #5036 dead). No new open Gloas PRs. CI green, zero clippy warnings. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Run 3024 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. New non-Gloas PRs: #5045 (remove @always_bls decorator, testing). CI green. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Run 3025 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. #4747 (FCR) still dirty with 146 review comments, not close to merge. CI green, zero compiler/clippy warnings. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Runs 3026-3027 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. New non-Gloas PRs: #5048 (testing label), #5047/#5033 (gossip validation for bellatrix/altair), #5045 (remove @always_bls). All deps up to date (only rand_xorshift 0.4→0.5 pending, requires rand 0.10 migration). CI green. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Run 3028 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. CI green. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Run 3029 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged (#5036/#4954/#4898/#4892/#4843/#4840/#4747/#4630). Non-Gloas: #5048/#5047/#5045/#5033 (testing/tooling). CI green. No actionable work.
- Run 3030 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. #4843 still mergeable_state=blocked. CI green (latest: data-encoding-macro-internal syn2 update, success). cargo audit: 1 rsa vuln (no fix). Zero clippy/compiler warnings. No actionable work.
- Run 3031 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. Latest release still v1.6.1. CI green. No actionable work.
- Run 3032 (2026-03-27): Steady state. No new consensus-specs merges. 8 open Gloas PRs unchanged (#4843 blocked, #4954 blocked, #4747 dirty/146 comments with active editorial review from 0xMushow/etan-status but not close to merge). CI green. cargo audit: 1 rsa vuln (no fix). All deps current. No actionable work.
- Run 3033 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. CI green (all nightly jobs passing). cargo audit: 1 rsa vuln (no fix). Only outdated root dep: rand_xorshift 0.4→0.5 (requires rand 0.10 migration). No actionable work.
- Run 3034 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged (#5036 dead, #4843/#4898/#4892 approved/stale, #4954/#4747/#4840/#4630 open). CI green. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Run 3035 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. CI green. No actionable work.
- Run 3036 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged. CI green, zero clippy warnings. cargo audit: 1 rsa vuln (no fix). No actionable work.
- Run 3037 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged (#5036/#4954/#4898/#4892/#4843/#4840/#4747/#4630). CI green (latest run: data-encoding-macro-internal syn2 update, success). cargo audit: 1 rsa vuln (no fix). Only outdated root dep: rand_xorshift 0.4→0.5 (requires rand 0.10 migration). No actionable work.
- Run 3038 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 8 open Gloas PRs unchanged (#4960/#4932/#4843/#4840/#4630/#4954/#4747/#4898/#4892 + #5036 dead). Latest release still v1.6.1. CI green (all 5 recent runs success). No actionable work.
- Run 3039 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). 9 open Gloas PRs unchanged (all blocked or dirty). CI green. No actionable work.
- Run 3040 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). Open Gloas PRs unchanged (#4843/#4898/#4892/#4954/#4747/#4840/#4630 + #5036 dead). Latest release still v1.6.1. CI green. No actionable work.
- Run 3041 (2026-03-27): Steady state. No new consensus-specs merges since #5044/#5046 (2026-03-26). #5048 merged (testing label exclusion, not relevant). 8 open Gloas PRs unchanged. CI green. All deps current (only rand_xorshift 0.4→0.5 pending, requires rand 0.10 migration). cargo audit: 1 rsa vuln (no fix). No actionable work.
