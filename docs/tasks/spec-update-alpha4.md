...
**Monitoring (runs 4008-4014, 2026-03-29/30):**
- No new consensus-specs merges or releases since alpha.4 (Mar 27). Last merge: #5053 (CI rename, Mar 27).
- #5056 (blob kzg commitment len check) still open, 0 reviews/comments. Already proactively implemented.
- All 8 open Gloas/Heze PRs unchanged: #4843 (approved/stalled since Mar 20, mergeable_state=blocked), #4747 (FCR, conflicting), #4954/#4898/#4892/#4960/#4932/#4840/#4630 (stale/unreviewed).
