...
Runs 2654-2694 (2026-03-26): No new spec PRs merged since run 2653 (latest merged: #5042 Mar 25). No new Gloas PRs opened. All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0 (spec-tests release), consensus-specs latest release v1.6.1. CI green, nightly green (Mar 25). Clippy: zero warnings. #4747 (FCR) updated (Mar 26) but still open/conflicting. cargo audit: 1 rsa vuln (no fix), 5 unmaintained. 10 TODOs all blocked on external deps. No actionable work.
