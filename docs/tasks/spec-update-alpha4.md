...
- Run 2972-2985: Monitoring passes — no new consensus-specs merges since #5044/#5046. Only new PR: #5045 (remove `@always_bls` decorator, test infra). v1.7.0-alpha.4 still not published. EF test vectors still v1.6.0-beta.0. All open Gloas PRs unchanged (#4843 APPROVED+MERGEABLE but not merged, #4898/#4892 APPROVED but stale, #4960 needs review, #4932 conflicting, #4954 still 0 reviews, #4747 still dirty/conflicting). CI green, clippy clean (zero warnings), cargo audit unchanged (1 rsa medium vuln, no fix available). All deps at latest compatible versions (only rand_xorshift 0.4→0.5 major bump available). No actionable work.
