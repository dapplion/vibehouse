...
- Runs 3953-3954 (2026-03-29): No new consensus-specs merges or releases since alpha.4 (Mar 27). Last merge: #5053 (Mar 27). All open Gloas/Heze PRs unchanged. #5052 (compute_shuffled_index cache reduction) is pyspec test infra, not actionable. Zero compatible dep updates. Zero clippy warnings. Build clean.
