...
Run 2948 (2026-03-26): Full audit. No new spec PRs merged or opened since #5044/#5046. Open Gloas PRs: #5045 (test infra), #4843 (variable PTC deadline, proactively implemented), #4898/#4892 (fork choice simplifications, already match), #4960/#4932 (test vectors), #4954 (milliseconds refactor), #4747 (FCR, CONFLICTING), #4840 (EIP-7843, stale), #4630 (EIP-7688, stale). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI green (latest: cmake 0.1.58 update). Clippy zero warnings. cargo audit: 1 rsa vuln (no fix available). rand_xorshift 0.4→0.5 not upgradable (requires rand ecosystem 0.9 migration). Running devnet health check.
