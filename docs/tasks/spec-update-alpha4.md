...
Runs 2536-2538: No new spec PRs merged since run 2535. All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.6.1). CI green. No actionable work.
