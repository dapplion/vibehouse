...
- Runs 3186-3195 (2026-03-27): Steady state. No new consensus-specs merges since #5048. Latest release v1.7.0-alpha.3 (alpha.4 tag a9bc79a7 exists, no release published). EF test vectors still v1.6.0-beta.0 (Sep 2025, upstream nightly generation failing since 2026-03-08). All deps at latest (0 updates). CI: all green (ci, nightly, spec-test-check). Clippy clean (0 warnings), cargo audit unchanged (1 transitive rsa vuln, no fix). All 8 open Gloas PRs unchanged: #4843 (approved), #4898/#4892 (approved/stale), #4954 (unreviewed), #4747 (FCR, 79 commits, 148+ reviews, dirty/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). Issue #36 remaining items all blocked or non-critical.
