...
Runs 2630-2633 (2026-03-26): No new spec PRs merged since run 2629. All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0 (spec-test release still v1.5.0). CI green, nightly green (Mar 25). cargo audit unchanged (1 rsa vuln, 5 unmaintained). cargo outdated: only rand_xorshift 0.4→0.5 (test utility, not worth updating). All 10 remaining TODOs blocked on external deps (EIP-7892 ×3, blst, PeerDAS, lmdb). No actionable work.
