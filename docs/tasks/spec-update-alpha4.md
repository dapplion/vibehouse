...
- Run 3155 (2026-03-27): Steady state. No new consensus-specs merges since #5048. Only #5049 (capella gossip validation) opened — not relevant. v1.7.0-alpha.4 still not published. CI: all green. Zero clippy/compiler warnings. Devnet verified: 4-node finalized epoch 8, clean Gloas fork transition. All open Gloas PRs unchanged. No actionable work.
