...
- Runs 3089-3097 (2026-03-27): Steady state. No new consensus-specs merges since #5048. v1.7.0-alpha.4 still not published (latest release = v1.6.1, alpha.3 = latest pre-release). All deps at latest (0 lockfile changes). CI: all green. Zero clippy warnings. cargo audit unchanged (1 rsa vuln, no fix). Open Gloas PRs unchanged (#4630/#4747/#4840/#4843/#4892/#4898/#4932/#4954/#4960). No actionable work.
