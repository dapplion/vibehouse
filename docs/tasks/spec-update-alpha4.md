...
- Run 3231 (2026-03-27): Steady state. No new consensus-specs merges since #5048. EF test vectors still v1.6.0-beta.0. All deps at latest (0 compatible updates). Compilation clean, clippy 0 warnings. All 9 open Gloas PRs unchanged. Non-Gloas open: #5049/#5047/#5045/#5033 (gossip validation testing) — not relevant.
