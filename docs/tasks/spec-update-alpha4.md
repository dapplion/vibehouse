...
- Run 3108 (2026-03-27): Steady state. No new consensus-specs merges since #5048. v1.7.0-alpha.4 still not published. 0 lockfile changes. CI: all green (latest: success 2026-03-27T03:15:30Z). Open Gloas PRs unchanged (#4630/#4747/#4840/#4843/#4892/#4898/#4932/#4954/#4960). #4840 no longer in recent open PRs list (may be closed/stale). No actionable work.
