...
Run 2502: No new spec PRs merged since run 2501. All open Gloas PRs unchanged (#5036, #4843, #4898, #4892, #4960, #4932, #4954, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). CI green (latest: 23563102012 success). No actionable work.
