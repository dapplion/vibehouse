...
- Runs 3047-3069 (2026-03-27): Steady state monitoring. No new consensus-specs merges since #5048. v1.7.0-alpha.4 still not published (latest release = v1.7.0-alpha.3). EF test vectors still v1.5.0. All deps at latest (0 lockfile changes). CI: all green. Open Gloas PRs unchanged (#4630/#4747/#4840/#4843/#4892/#4898/#4932/#4954/#4960). No actionable work.
