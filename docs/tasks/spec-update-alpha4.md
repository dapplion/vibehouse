...
Runs 2820-2848 (2026-03-26): No new spec PRs merged since run 2819. #5044 still open (0 comments, 0 reviews — blocking alpha.4 release). All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630, #5044). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI green (ci, nightly, spec-test-check all passing Mar 26). cargo audit unchanged (1 rsa vuln, 5 unmaintained). Clippy zero warnings. No actionable work.
