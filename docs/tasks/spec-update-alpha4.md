...
- Run 3138 (2026-03-27): Steady state. No new consensus-specs merges since #5048. Latest merged: #5048 (testing label exclusion, 2026-03-27). v1.7.0-alpha.4 tag exists, no GitHub Release (latest = v1.7.0-alpha.3, latest published release = v1.6.1). All deps at latest (0 lockfile changes from cargo update --dry-run). CI: ci green, nightly in progress (24/26 jobs passed, http-api-tests still running). Open Gloas PRs unchanged: #4843/#4898/#4892/#4954/#4747/#4960/#4932/#4840/#4630. Also in search results: #4484 (EIP-7782 6s slots), #4704 (remove old deposit mechanism) — neither relevant. No actionable work.
- Run 3139 (2026-03-27): Steady state. No new consensus-specs merges since #5048. All deps at latest (0 lockfile changes). CI: ci green, nightly 25/26 passed (http-api-tests fulu still running). Open Gloas PRs unchanged. No actionable work.
- Run 3140 (2026-03-27): Steady state. No new consensus-specs merges since #5048. All deps at latest (0 lockfile changes). CI: ci green (latest push success), nightly in progress. Open Gloas PRs unchanged. Non-Gloas: #5049/#5047/#5033 (gossip validation capella/bellatrix/altair) — not relevant. No actionable work.
- Run 3141 (2026-03-27): Steady state. No new consensus-specs merges since #5048. Audited #5035 (same-epoch proposer preferences, merged 2026-03-25) and #5044 (compute_ptc speedup, merged 2026-03-26) — both already implemented, no code changes needed. CI: all green including nightly (26/26 jobs). Open Gloas PRs unchanged. No actionable work.
- Run 3142 (2026-03-27): Steady state. No new consensus-specs merges since #5048. EF test vectors still v1.6.0-beta.0 (Sep 2025). v1.7.0-alpha.4 tag exists, no GitHub Release published. CI: all green (ci + nightly). cargo audit: 1 rsa vuln (no fix). Only outdated dep: rand_xorshift 0.4→0.5 (blocked by rand_core version split). All 8 open Gloas PRs unchanged. No actionable work.
- Run 3143 (2026-03-27): Steady state. No new consensus-specs merges since #5048. v1.7.0-alpha.4 tag exists, no GitHub Release published (latest = v1.7.0-alpha.3). All deps at latest (0 lockfile changes). CI: all green (ci + nightly). Open Gloas PRs unchanged: #4843/#4898/#4892/#4954/#4747/#4960/#4932/#4840/#4630. No actionable work.
- Run 3144 (2026-03-27): Steady state. No new consensus-specs merges since #5048. All deps at latest (0 lockfile changes). CI: all green (ci + nightly). Open Gloas PRs unchanged. Non-Gloas open: #5049/#5047/#5033 (gossip validation capella/bellatrix/altair), #5045 (remove @always_bls) — not relevant. No actionable work.
- Run 3145 (2026-03-27): Steady state. No new consensus-specs merges since #5048. All deps at latest (0 lockfile changes). CI: all green (ci + nightly). Zero clippy warnings. All 8 open Gloas PRs unchanged (#4843/#4898/#4892/#4954/#4747/#4960/#4932/#4840/#4630). No actionable work.
