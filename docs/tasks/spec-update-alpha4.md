...
- Run 2971: Monitoring pass — no new spec merges, no new releases, CI green, clippy clean, all deps up to date (9 behind latest are all major version bumps). No actionable work.
- Run 2972-2993: Monitoring passes — no new consensus-specs merges since #5044/#5046. Only new PR: #5045 (remove `@always_bls` decorator, test infra). v1.7.0-alpha.4 still not published (latest release = v1.7.0-alpha.3, consensus-specs latest release = v1.6.1). EF test vectors still v1.5.0 (2025-05-07). All open Gloas PRs unchanged (#4843 APPROVED but mergeable_state=blocked, #4898/#4892 APPROVED but stale, #4960 needs review, #4932 conflicting, #4954 still 0 reviews, #4747 still dirty/conflicting with 146 review comments). CI green, clippy clean (zero warnings), cargo audit unchanged (1 rsa vuln, 5 unmaintained warnings). All deps at latest compatible versions. No actionable work.
- Run 2994-3000: Monitoring passes — no new consensus-specs merges since #5044/#5046 (2026-03-26T19:03Z). No new releases (alpha.4 tag exists but release not published, latest = alpha.3; EF tests latest = v1.6.0-beta.0, consensus-spec-tests latest release = v1.5.0). All open Gloas PRs unchanged (#4843 APPROVED/blocked, #4747 CONFLICTING with 146+ reviews, #4954 0 reviews, #4898/#4892 stale). CI green, clippy clean (zero warnings). cargo audit unchanged (1 rsa vuln, 5 unmaintained). All deps at latest compatible versions. No actionable work.
- Run 3001: Monitoring pass — no new consensus-specs merges since #5044/#5046 (2026-03-26T19:03Z). No new releases (alpha.4 still not published, latest = alpha.3; consensus-spec-tests latest = v1.6.0-beta.0). All 9 open Gloas PRs unchanged (#4843 MERGEABLE, #4898/#4892 MERGEABLE, #4960 MERGEABLE, #4932 CONFLICTING, #4954 MERGEABLE, #4747 CONFLICTING, #4840 MERGEABLE, #4630 CONFLICTING). CI green, clippy clean (zero warnings), cargo audit unchanged (1 rsa vuln). No actionable work.
