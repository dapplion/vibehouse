...
**Steady state summary (runs 3202-3267, 2026-03-27):**
...
- All 8 open Gloas PRs unchanged: #4843 (approved/mergeable), #4898/#4892 (stale), #4954 (unreviewed), #4747 (FCR, 82 commits, conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale)
