...
- Runs 3047-3185 (2026-03-27): Steady state monitoring. No new consensus-specs merges since #5048. v1.7.0-alpha.4 tag exists (a9bc79a7) but no GitHub Release published (latest release = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0 (Sep 2025, upstream nightly generation failing since 2026-03-08). All deps at latest (cargo update --dry-run clean). CI: all green (ci, nightly, spec-test-check). Zero clippy warnings. All 8 open Gloas PRs unchanged: #4843 (approved), #4898/#4892 (approved/stale), #4954 (unreviewed), #4747 (FCR, 79 commits, 148 reviews, dirty/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). Non-Gloas: #5049/#5047/#5045/#5033 (gossip validation/testing) — not relevant.
- Runs 3186-3197 (2026-03-27): Steady state. No new consensus-specs merges since #5048. Latest release v1.7.0-alpha.3 (alpha.4 tag a9bc79a7 exists, no release published). EF test vectors still v1.6.0-beta.0 (Sep 2025, upstream nightly generation failing since 2026-03-08). All deps at latest (rand_xorshift 0.4→0.5 blocked by rand_core version conflict). CI: all green (ci, nightly, spec-test-check). Clippy clean (0 warnings), cargo audit unchanged (1 transitive rsa vuln, no fix). All 8 open Gloas PRs unchanged: #4843 (approved), #4898/#4892 (approved/stale), #4954 (unreviewed), #4747 (FCR, 79 commits, 148+ reviews, dirty/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). Issue #36 remaining items all blocked or non-critical.
- Run 3198 (2026-03-27): Steady state. No new consensus-specs merges since #5048. All deps at latest (cargo update --dry-run clean). CI: all green. All open Gloas PRs unchanged. #4747 (FCR) still unmergeable (79 commits, 148 reviews).
- Run 3199 (2026-03-27): **v1.7.0-alpha.4 released** with test vectors. Downloaded and ran new vectors — `process_ptc_window__shifts_all_epochs` failed. Root cause: CommitteeCache epoch bound too restrictive for PTC window lookahead (N+2). Fixed by relaxing bound to current + MIN_SEED_LOOKAHEAD + 1 and refactoring compute_ptc to accept explicit cache. All tests passing: 80/80 + 140/140 EF, 1033 state_processing, 1085 types, 4998 workspace. Commit 8a83ed8ab pushed.
- Run 3200 (2026-03-27): **CI fix** — beacon_chain tests (gloas) failed: `attestation_production::produces_attestations` panicked with `PtcWindowComputeError(NoActiveValidators)`. Root cause: `process_ptc_window` propagated error when computing PTC for slots with empty committees (16 validators on MainnetEthSpec = many empty slots). Fix: catch `NoActiveValidators` in `process_ptc_window` and fill with zeros (matching `initialize_ptc_window` behavior). All tests pass: 80/80 + 140/140 EF, 1033 state_processing, 999 beacon_chain. Commit 8181c4647 pushed. No new consensus-specs merges. All 8 open Gloas PRs unchanged.
- Run 3201 (2026-03-27): Steady state. No new consensus-specs merges since #5048. Latest GitHub release still v1.6.1 (alpha.4 tag a9bc79a7 exists, test vectors released). All open Gloas PRs unchanged: #4843 (approved), #4898/#4892 (stale), #4954 (unreviewed), #4747 (FCR, updated today, still unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). Updated transitive deps: windows-sys→0.61.2, socket2→0.6.3, data-encoding-macro-internal syn 1→2, prettyplease itertools 0.12→0.14. CI in progress (check+clippy passed). Cargo audit unchanged. Commit 71c46c13e pushed.
- Runs 3202-3213 (2026-03-27): Steady state. v1.7.0-alpha.4 published as GitHub release (prerelease). No new consensus-specs merges since #5048. All 8 open Gloas PRs unchanged: #4843 (approved/mergeable), #4898/#4892 (approved/stale), #4954 (unreviewed/mergeable), #4747 (FCR, 79 commits, 148+ reviews, conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). All deps at latest (0 compatible updates, 9 behind latest requiring major bumps). CI: all green (ci, nightly, spec-test-check). Cargo audit: 1 rsa transitive vuln (no fix). Issue #36: 5 blocked, 2 non-critical remaining. No actionable work across 12 consecutive runs.
- Run 3214 (2026-03-27): Devnet verification post-alpha.4 changes. Built and ran 4-node devnet — finalized_epoch=8 at slot 81, clean Gloas fork transition at epoch 1. PTC window cache (commit 8a83ed8ab), mainnet empty-committee fix (8181c4647), and dep updates (71c46c13e) all working correctly end-to-end. No new consensus-specs merges. All 8 open Gloas PRs unchanged.
- Runs 3215-3230 (2026-03-27): Steady state. No new consensus-specs merges since #5048. CI: all green. Clippy: 0 warnings. All deps at latest (0 compatible updates). Cargo audit: unchanged (1 transitive rsa vuln, no fix). All 9 open Gloas PRs unchanged throughout: #4843 (approved/mergeable), #4898/#4892 (approved/stale), #4954 (unreviewed/mergeable), #4747 (FCR, 79 commits, 148+ reviews, conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). Issue #36: 5 blocked, 2 non-critical remaining. Notable: run 3222 updated Rust stable 1.94.0→1.94.1 and nightly to 1.96.0-nightly (2026-03-26), zero warnings. Run 3229: devnet verification post-payload_present rename — 4-node finalized_epoch=8, clean Gloas fork transition. No actionable spec work across 16 consecutive runs.
- Runs 3231-3235 (2026-03-27): Steady state. No new consensus-specs merges since #5048. All deps at latest (0 compatible updates). CI: green (latest run 18:04 UTC passed). Full test verification in run 3235: EF tests 80/80 + 140/140, state_processing 1033/1033, fork_choice 121/121, clippy clean. All 9 open Gloas PRs unchanged: #4843 (approved/mergeable), #4898/#4892 (approved/stale), #4954 (unreviewed), #4747 (FCR, updated today with new review comments, still conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). No actionable work.
- Runs 3236-3252 (2026-03-27): Steady state. No new consensus-specs merges since #5048. CI: all green (ci, nightly). All deps at latest (0 compatible updates). New non-relevant PRs observed: #5049 (capella gossip validation tests), #5050 (networking test yield order), #5051 (test timeout increase), #5052 (reduce compute_shuffled_index cache — Python tooling). All 9 open Gloas PRs unchanged: #4843 (approved/mergeable), #4898/#4892 (approved/stale), #4954 (unreviewed), #4747 (FCR, 82 commits, tests being added, still conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). Devnet verifications in runs 3239 and 3252: 4-node finalized_epoch=8, clean Gloas fork transition. No actionable work.
- Run 3253 (2026-03-27): Steady state. No new consensus-specs merges since #5051 (test timeout — CI only). All deps at latest (0 compatible updates). CI: green (latest run 18:04 UTC). New merged: #5051 (increase test timeout 12h→24h — not relevant). New open: #5053 (rename nightly-tests.yml — CI only). All 9 open Gloas PRs unchanged. No actionable work.
- Runs 3254-3256 (2026-03-27): Steady state. No new consensus-specs merges since #5051. CI: green. Clippy: 0 warnings. EF tests: 80/80 + 140/140 passing. Cargo audit: unchanged (1 transitive rsa vuln, no fix). All deps at latest. All 8 open Gloas PRs unchanged: #4843 (approved/mergeable), #4898/#4892 (approved/stale), #4954 (unreviewed), #4747 (FCR, 82 commits, conflicting/unmergeable, REVIEW_REQUIRED), #4960/#4932 (test vectors), #4840/#4630 (stale). Nightly tests: all green (Mar 24-27, Mar 23 slasher flake resolved). No actionable work.
- Run 3257 (2026-03-27): Steady state. No new consensus-specs merges since #5051. All deps at latest (0 compatible updates). CI: green. All 8 open Gloas PRs unchanged: #4843 (open), #4898/#4892 (open/stale), #4954 (open/stale), #4747 (FCR, conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). No actionable work.
- Run 3258 (2026-03-27): Steady state. No new consensus-specs merges since #5051. All deps at latest (0 compatible updates). All 8 open Gloas PRs unchanged: #4843 (blocked), #4898/#4892 (blocked/unknown), #4954 (blocked), #4747 (FCR, dirty/unmergeable), #4960/#4932 (test vectors), #4840 (draft), #4630 (dirty). No actionable work.
- Run 3259 (2026-03-27): Steady state. No new consensus-specs merges since #5051. All deps at latest (0 compatible updates). CI: green (latest run success 18:04 UTC). All 8 open Gloas PRs unchanged: #4843 (open), #4898/#4892 (stale), #4954 (stale), #4747 (FCR, updated today, still conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). Non-Gloas open: #5053 (rename tests.yml), #5052 (reduce cache), #5050/#5049 (gossip validation tests), #5045 (remove decorator) — none relevant. No actionable work.
- Run 3260 (2026-03-27): Steady state. Only new merge: #5051 (test timeout 12h→24h — CI only). All deps at latest. CI: green. Clippy: 0 warnings. Cargo audit: unchanged (1 transitive rsa vuln, no fix). All 8 open Gloas PRs unchanged: #4843 (open), #4898/#4892 (stale), #4954 (stale), #4747 (FCR, 79 commits, 144 reviews, actively discussed but still conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). No actionable work.
- Run 3261 (2026-03-27): Steady state. No new consensus-specs merges since #5051. All deps at latest (0 compatible updates). Clippy: 0 warnings. All 8 open Gloas PRs unchanged: #4843 (blocked), #4898/#4892 (blocked/stale), #4954 (blocked), #4747 (FCR, dirty/unmergeable), #4960/#4932 (test vectors, dirty/blocked), #4840 (blocked), #4630 (dirty). No actionable work.
- Run 3262 (2026-03-27): Steady state. No new consensus-specs merges since #5051. All deps at latest (0 compatible updates). CI: green (ci + nightly). All 9 open Gloas PRs unchanged: #4843 (blocked), #4898/#4892 (blocked/stale), #4954 (blocked), #4747 (FCR, dirty/unmergeable, updated today), #4960/#4932 (test vectors, dirty/blocked), #4840 (blocked), #4630 (dirty). Non-Gloas open: #5053/#5052/#5050/#5049/#5045 (CI/testing — not relevant). No actionable work.
- Run 3263 (2026-03-27): Steady state. No new consensus-specs merges since #5051. All deps at latest (0 compatible updates). All 8 open Gloas PRs unchanged: #4843 (blocked), #4898/#4892 (stale), #4954 (stale), #4747 (FCR, conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). Issue #36: 5 blocked, 2 non-critical remaining. No actionable work.
- Run 3264 (2026-03-27): Steady state. No new consensus-specs merges since #5051. All deps at latest (0 compatible updates). CI: green. All 8 open Gloas PRs unchanged. No actionable work.
- Run 3265 (2026-03-27): Steady state. No new consensus-specs merges since #5051. All deps at latest (0 compatible updates). All 8 open Gloas PRs unchanged: #4843, #4898/#4892, #4954, #4747 (FCR), #4960/#4932, #4840/#4630. No actionable work.
- Run 3266 (2026-03-27): Steady state. New merges: #5052 (reduce cache — Python tooling), #5053 (rename tests.yml — CI). Neither relevant. All deps at latest (0 compatible updates). All 9 open Gloas PRs unchanged. No actionable work.
