...
- Runs 3108-3113 (2026-03-27): Steady state. No new consensus-specs merges since #5048. v1.7.0-alpha.4 still not published. 0 lockfile changes. CI: all green (latest: success 2026-03-27T03:15:30Z). Open Gloas PRs unchanged (#4630/#4747/#4840/#4843/#4892/#4898/#4932/#4954/#4960). New non-Gloas: #5049 (capella gossip), #5047 (bellatrix gossip), #5045 (remove @always_bls) — not relevant. No actionable work.
