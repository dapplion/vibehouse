...
Runs 2549-2554: No new spec PRs merged since run 2548. All open Gloas PRs unchanged (#4843, #4898, #4892, #4954, #4747, #4840, #4630). #4747 still conflicting (138 review comments, mergeable=false). #5036 still open but effectively dead. v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI green (all runs success, nightly Mar 25 green). No actionable work.
