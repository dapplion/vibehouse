...
Runs 2654-2705 (2026-03-26): No new spec PRs merged since run 2653 (latest merged: #5042 Mar 25). No new Gloas PRs opened. All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0 (spec-tests release), consensus-specs latest release v1.6.1. CI green, nightly green (Mar 25). Spec-test-check workflow green. #4747 (FCR) still open/conflicting (79 commits, 144 review comments, mergeable_state=dirty, fresh review comments from etan-status Mar 26 re: asymmetric balance tests). cargo audit unchanged (1 rsa vuln, 5 unmaintained). 10 remaining TODOs all blocked on external deps. No actionable work.
