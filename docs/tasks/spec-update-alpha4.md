...
- Runs 3231-3234 (2026-03-27): Steady state. No new consensus-specs merges since #5048. All deps at latest (0 compatible updates). CI: in progress (latest run 18:04 UTC), previous run green. All 9 open Gloas PRs unchanged: #4843 (approved/mergeable), #4898/#4892 (approved/stale), #4954 (unreviewed), #4747 (FCR, updated today, conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). No actionable work.
