...
- Runs 3187-3189 (2026-03-27): Steady state. No new consensus-specs merges since #5048. Latest release still v1.7.0-alpha.3 (alpha.4 tag exists, no release published). All deps at latest (0 updates available). CI: all green (ci, nightly, spec-test-check). All 8 open Gloas PRs unchanged. #4747 FCR still dirty/unmergeable (79 commits, 148 reviews).
