...
**Monitoring (runs 4073-4075, 2026-03-30):**
- No new consensus-specs merges or releases since alpha.4 (Mar 27). Last actionable merge: #5054 (test workflow, Mar 29). #5057 (ruff dep) and #5058 (setup-uv action) still open — CI deps only.
- #5056 (blob kzg commitment len check): still open, approved by jtraglia (2 reviews), mergeable, not merged. Already proactively implemented.
- All open Gloas/Heze PRs unchanged: #4843 (approved/mergeable since Mar 20), #4747 (FCR, conflicting), #5056 (approved/mergeable), #4954/#4898/#4892/#4960/#4932/#4840/#4630 (stale/unreviewed).
