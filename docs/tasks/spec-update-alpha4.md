...
Run 2872 (2026-03-26): No new spec PRs merged since run 2871. #5044 still open (0 comments, 0 reviews, mergeable_state=blocked — blocking alpha.4 release). All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630, #5044). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI run 23603229624 in progress (all 6 jobs running for unicode-segmentation fix). No actionable work.
