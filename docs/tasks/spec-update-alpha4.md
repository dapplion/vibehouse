...
- Runs 3231-3233 (2026-03-27): Steady state. No new consensus-specs merges since #5048. All deps at latest (0 compatible updates). CI: nearly complete (check/clippy/fmt/EF tests/unit/network/op_pool/http_api all passed, beacon_chain in progress). All 9 open Gloas PRs unchanged: #4843 (approved/mergeable), #4898/#4892 (approved/stale), #4954 (unreviewed), #4747 (FCR, conflicting/unmergeable), #4960/#4932 (test vectors), #4840/#4630 (stale). New open PR #5049 (gossip validation capella) — not Gloas-related. No actionable work.
