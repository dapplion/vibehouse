...
Runs 2924-2956 (2026-03-26): Continuous monitoring. #5044 and #5046 merged (Mar 26 19:03Z) — both Python test infra optimizations to unblock alpha.4 release. #5035 ("Allow same epoch proposer preferences") confirmed already implemented in both gossip validation and VC broadcast paths. All open Gloas PRs unchanged (#5045, #4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). v1.7.0-alpha.4 release still not published (latest = v1.6.1). EF test vectors still v1.6.0-beta.0. CI fully green (ci, nightly, spec-test-check). Clippy zero warnings. No actionable work.
