...
- Run 2972-2979: Monitoring passes — no new consensus-specs merges since #5044/#5046. Only new PR: #5045 (remove `@always_bls` decorator, test infra). v1.7.0-alpha.4 still not published. EF test vectors still v1.6.0-beta.0. All open Gloas PRs unchanged (#4843, #4954 still 0 reviews, #4747 still dirty). CI green, clippy clean, cargo audit unchanged (1 rsa medium vuln, no fix available). No actionable work.
