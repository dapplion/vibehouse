...
Runs 2571-2576: No new spec PRs merged since run 2570. All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630). #4747 still dirty/conflicting. #4960/#4932 test vector PRs still open. v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI green. No actionable work.
