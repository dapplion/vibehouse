...
- Run 3008: No new consensus-specs merges since #5044/#5046 (2026-03-26T19:03Z). v1.7.0-alpha.4 still not published (latest release = v1.7.0-alpha.3). All 9 open Gloas PRs unchanged (#4843, #4898, #4892, #4954, #4747, #4960, #4932, #4840, #4630). New non-Gloas open PRs: #5033 (altair gossip validation). CI run 23624361655 (syn 1→2): check+clippy pass, tests in progress. Nightly CI green. cargo audit: 1 rsa vuln + 5 allowed warnings (all transitive, not actionable). Zero clippy warnings. No outdated deps except rand_xorshift (blocked on rand_core 0.10). Steady state.
