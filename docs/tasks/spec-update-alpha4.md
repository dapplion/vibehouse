...
Runs 2874-2877 (2026-03-26): No new spec PRs merged since run 2873. #5044 still open (0 comments, 0 reviews — blocking alpha.4 release). All open Gloas PRs unchanged (#4843, #4898, #4892, #4960, #4932, #4954, #4747, #4840, #4630, #5044). v1.7.0-alpha.4 release still not published (latest = v1.7.0-alpha.3). EF test vectors still v1.6.0-beta.0. CI: nightly green, ci in progress for unicode-segmentation 1.13.2 fix (check+clippy+ef-tests passed). No actionable work.
