...
- Runs 3089-3091 (2026-03-27): Steady state. No new consensus-specs merges since #5048. v1.7.0-alpha.4 still not published (latest release = v1.6.1, alpha.3 = latest pre-release). All deps at latest (0 lockfile changes). CI: all green. Zero clippy warnings. Open Gloas PRs unchanged. Non-Gloas: #5049 (capella gossip), #5047 (bellatrix gossip), #5033 (altair gossip), #5045 (remove @always_bls) — none relevant. No actionable work.
