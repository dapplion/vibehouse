...
- ✅ Envelope processing state transition (`process_execution_payload_envelope` — 278 lines, spec-compliant)

### Remaining
- [ ] Wire envelope processing into beacon chain import pipeline
