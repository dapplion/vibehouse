...
pub(crate) static HTTP_API_PATHS_TOTAL: LazyLock<Result<IntCounterVec>> = LazyLock::new(|| {
...
pub(crate) static HTTP_API_STATUS_CODES_TOTAL: LazyLock<Result<IntCounterVec>> =
    LazyLock::new(|| {
        try_create_int_counter_vec(
...
pub(crate) static HTTP_API_PATHS_TIMES: LazyLock<Result<HistogramVec>> = LazyLock::new(|| {
...
pub(crate) static HTTP_API_BLOCK_BROADCAST_DELAY_TIMES: LazyLock<Result<HistogramVec>> =
    LazyLock::new(|| {
        try_create_histogram_vec(
...
pub(crate) static HTTP_API_BLOCK_GOSSIP_TIMES: LazyLock<Result<HistogramVec>> =
    LazyLock::new(|| {
...
pub(crate) static HTTP_API_STATE_SSZ_ENCODE_TIMES: LazyLock<Result<Histogram>> =
    LazyLock::new(|| {
...
pub(crate) static HTTP_API_STATE_ROOT_TIMES: LazyLock<Result<Histogram>> = LazyLock::new(|| {
    try_create_histogram(
