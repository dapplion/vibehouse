...
mod test {
    ...
    fn test_rlp_encode_eip1559_block() {
        let header = ExecutionBlockHeader {
            ...
            difficulty: Uint256::from(0x0002_0000),
            number: Uint256::from(0x01_u64),
            gas_limit: Uint256::from(0x0163_4578_5d8a_0000_u64),
            gas_used: Uint256::from(0x0001_5534_u64),
            timestamp: 0x079e,
            extra_data: vec![0x42],
    ...
    fn test_rlp_encode_block_16182891() {
        let header = ExecutionBlockHeader {
            ...
            number: Uint256::from(16_182_891),
            gas_limit: Uint256::from(0x01c9_c380),
            gas_used: Uint256::from(0x00e9_b752),
            timestamp: 0x6399_bf63,
            ...
            nonce: Hash64::ZERO,
            base_fee_per_gas: Uint256::from(0x0003_4187_b238_u64),
            withdrawals_root: None,
            blob_gas_used: None,
            excess_blob_gas: None,
            parent_beacon_block_root: None,
    ...
    fn test_rlp_encode_block_deneb() {
        let header = ExecutionBlockHeader {
            ...
            gas_limit: Uint256::from(27_482_534),
            gas_used: Uint256::ZERO,
            timestamp: 1_692_132_829_u64,
    ...
    fn test_rlp_encode_block_electra() {
        let header = ExecutionBlockHeader {
            ...
            gas_limit: Uint256::from(30_000_000),
            gas_used: Uint256::from(3_716_848),
            timestamp: 1_730_921_268,
            ...
            excess_blob_gas: Some(44_695_552),
