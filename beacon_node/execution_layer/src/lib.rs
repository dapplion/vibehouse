...
pub use engine_api::{
    Address, BeaconBlockRef, BlockByNumberQuery, ClientVersionV1, CommitPrefix,
    ConsolidationRequest, EngineCapabilities, EthSpec, ExecutionBlock, ExecutionBlockHash,
    ExecutionPayload, ExecutionPayloadBodyV1, ExecutionPayloadHeader, ExecutionPayloadRef,
    FixedVector, ForkName, Hash256, NewPayloadRequest, NewPayloadRequestGloas, PayloadAttributes,
    PayloadAttributesV1, PayloadStatusV1, PayloadStatusV1Status, Transactions, Uint256,
    VariableList, Withdrawal, Withdrawals, auth, http, json_structures,
};
use engine_api::{GetPayloadResponse, GetPayloadResponseType, LATEST_TAG};
use engines::Engine;
...
impl From<EngineError> for Error {
    fn from(e: EngineError) -> Self {
        match e {
            ...
            // TODO: consider refactoring these error enums (#36)
...
pub enum BlockProposalContents<E: EthSpec, Payload: AbstractExecPayload<E>> {
    ...
    PayloadAndBlobs {
        ...
        // TODO: this should probably be a separate variant/superstruct (#36)
...
fn verify_builder_bid<E: EthSpec>(
    ...
    let expected_withdrawals_root = payload_attributes
        ...
        .ok()
        .cloned()
        .and_then(|withdrawals| Withdrawals::<E>::new(withdrawals).ok())
